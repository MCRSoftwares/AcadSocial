    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_request', models.DateTimeField(default=datetime.datetime(2015, 1, 5, 19, 37, 14, 367000, tzinfo=utc), verbose_name='request date')),
                ('data_expiracao', models.DateTimeField(default=datetime.datetime(2015, 1, 6, 19, 37, 14, 367000, tzinfo=utc), verbose_name='expiration date')),
